...
<div class="container-fluid row">
    <div id="sidebar-container" class="bg-primary col-3">
        <div class="menu align-items-md-start">
            ...
            <a href="#" class="d-flex">
                ...
                <span class="d-none d-md-flex"> Clientes </span>
            </a>
            <a href="#" class="d-flex menu-active">
                ...
                <span class="d-none d-md-flex"> Productos </span>
            </a>
            <a href="#" class="d-flex ">
            ...
            <a href="#" class="d-flex">
                ...
                <span class="d-none d-md-flex"> Salir </span>
            </a>
        </div>
    </div>
    <!-- summary -->
    <div id="summary" class="col-9">
        ...
        <a href="${pageContext.request.contextPath}/#" class="btn btn-dark float-start">
            Ver Auditoria
        </a>
