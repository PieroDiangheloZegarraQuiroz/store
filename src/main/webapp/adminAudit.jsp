...
<div class="container-fluid row">
    ...
    <div id="summary" class="col-9">
        ...
        <table id="table" class="table text-light">
            ...
            <tbody>
            <c:forEach var="auditProduct" items="${audit}">
                <tr align="center">
                    <td>${auditProduct.date}</td>
                    <td>${auditProduct.event}</td>
                    <td>${auditProduct.nameOld}</td>
                    <td>${auditProduct.newName}</td>
                    <td>${auditProduct.priceOld}</td>
                    <td>${auditProduct.priceNew}</td>
                    <td>${auditProduct.stockOld}</td>
                    <td>${auditProduct.stockNew}</td>
                    <td>${auditProduct.author}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
