...
<header class="main-header flex justify-evenly sm:justify-between container mx-auto" id="navbar" style="border-bottom: 5px solid #7960CE">
    ...
    <nav class="flex items-center w-6/12 justify-start sm:justify-end nav-header">
        ...
        <c:if test="${validats}">
            <a href="${pageContext.request.contextPath}/ServletUsuario?accion=editar&idCliente=${idCliente}" class="px-10 py-2 border my-3 mx-5 rounded hover:border-purple-700 hover:text-purple-800 duration-700 transform hover:scale-90" href="idCliente=${idCliente}&direccion=${direccion}&idDistrito=${idDistrito}">
