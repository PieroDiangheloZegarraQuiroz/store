...
<header class="main-header flex justify-evenly sm:justify-between container mx-auto" id="navbar" style="border-bottom: 5px solid #7960CE">
    <nav class="flex items-center w-6/12 justify-evenly sm:justify-between nav-header">
        <img class="elettore" src="img/sad.PNG" alt="logo" width="60">
    ...
    <nav class="flex items-center w-6/12 justify-start sm:justify-end nav-header">
        ...
        <c:if test="${!validats}">
            ...
            <a href="register.jsp"
               class="p-5 px-10 py-2 border my-3 mx-5 rounded transform hover:scale-110 hover:border-purple-700 hover:text-white-800 duration-700">Registro</a>
        </c:if>
        <c:if test="${validats}">
            <!-- recibe de validar serrvlet -->
            <a href="${pageContext.request.contextPath}/#"
               class="px-12 py-2 border my-3 mx-5 rounded hover:border-purple-700 hover:text-purple-800 duration-700 text-center transform hover:scale-90">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-4 text-center" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<section class="container w-full sm:px-0  px-4 my-5">
                        ...
                        <c:forEach items="${productsHome}" var="p">
                            ...
                            <div class="swiper-slide">
                                <div class="card-product w-60 h-80">
                                    ...
                                    <div class="text-base text-dark-400 absolute bottom-2 left-5">
    ...
    <!--CHATBOX-->
        <div class="consulta">
            <div class="men">
                    <p>Haz Tu Consulta Aqui</p>
            </div>
        </div>
        <div class="bott">
            <button onclick="popupToggle()">
                <i class='bx bxs-message-rounded-dots bx-fade-up-hover bx-md'></i>
            </button>
        </div>
    <div id="chat-content">
        <!--CHATHEADER-->
        ...
        <div>
            ...
            <div id="chat-footer">
            <div class="input">
                <input type="text" id="user" name="nombre" placeholder=" Por favor Iniciar Sesion" readonly value="${nameHome}">
            </div>
            <div class="input">
                <input id="mensaje" placeholder=" Escribe Un Mensaje" name="mensaje">
            </div>
