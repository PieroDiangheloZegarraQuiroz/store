...
import com.yactayo.xprs.modelsDTO.Role;
...
public class EmployeeDAO implements Repostory<Employee> {
    ...
    public void save(Employee employee) {
        ...
        try (Connection conn = getConnection();
            ...
            stmt.setString(1, employee.getNames());
            stmt.setString(2, employee.getSurnames());
            ...
            if (employee.getIdEmployee() != null && employee.getIdEmployee() > 0) {
                ...
                stmt.setInt(3, employee.getDocIdentity());
